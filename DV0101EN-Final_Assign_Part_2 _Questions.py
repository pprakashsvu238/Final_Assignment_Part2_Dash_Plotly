...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemprate_sales=recession_data[['unemployment_rate','Vehicle_Type','Automobile_Sales']]
        R_chart4 = dcc.Graph(figure=px.bar(unemprate_sales,x='unemployment_rate',y='Automobile_Sales',hue='Vehicle_Type',title="Effect of Unemployment Rate on Vehicle Type and Sales"))


        return [
            html.Div(className='chart-item', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={.....}),
            html.Div(className='chart-item', children=[html.Div(children=R_chart3),html.Div(R_chart3)],style={....})
            ]
...
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(figure=px.line(yearly_data,x='Month',y='Automobile_Sales',title="Monthly Automobile Sales in the year {}".format(input_year)))
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,values='Advertising_Expenditure',names='Vehicle_Type',title="Total Expenditure share by Vehicle Type in the year {}".format(input_year)))
